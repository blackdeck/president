...
export var buildings = {
    money1: {name: "Money1", location: 'earth', tier: 1, type: 'money', base_cost: {'balances.money': 1,   'balances.goods': 0,    'balances.oil': 0},     cost_grows: 1.4,  profit: {'balances.money': 1},    base_duration: 10, cycle: 10,  text: 'text', isHidden: (store) => false },
    goods1: {name: "Goods1", location: 'earth', tier: 1, type: 'goods', base_cost: {'balances.money': 5,   'balances.goods': 0,    'balances.oil': 0},     cost_grows: 1.41, profit: {'balances.goods': 1},    base_duration: 20, cycle: 20,  text: 'text', isHidden: (store) => store.buildings.money1.level == 0 },
    oil1:   {name: "Oil1",   location: 'earth', tier: 1, type: 'oil',   base_cost: {'balances.money': 0,   'balances.goods': 10,   'balances.oil': 0},     cost_grows: 1.42, profit: {'balances.oil': 1},      base_duration: 30, cycle: 30,  text: 'text', isHidden: (store) => store.buildings.goods1.level == 0 },
    money2: {name: "Money2", location: 'earth', tier: 2, type: 'money', base_cost: {'balances.money': 0,   'balances.goods': 30,   'balances.oil': 0},     cost_grows: 1.43, profit: {'balances.money': 40},   base_duration: 40, cycle: 50,  text: 'text', isHidden: (store) => store.buildings.oil1.level == 0 },
    goods2: {name: "Goods2", location: 'earth', tier: 2, type: 'goods', base_cost: {'balances.money': 0,   'balances.goods': 0,    'balances.oil': 100},   cost_grows: 1.44, profit: {'balances.goods': 50},   base_duration: 50, cycle: 100, text: 'text', isHidden: (store) => store.buildings.money2.level == 0 },
    oil2:   {name: "Oil2",   location: 'earth', tier: 2, type: 'oil',   base_cost: {'balances.money': 2500,'balances.goods': 0,    'balances.oil': 0},     cost_grows: 1.45, profit: {'balances.oil': 70},     base_duration: 60, cycle: 200, text: 'text', isHidden: (store) => store.buildings.goods2.level == 0 },
    money3: {name: "Money3", location: 'earth', tier: 3, type: 'money', base_cost: {'balances.money': 0,   'balances.goods': 0,    'balances.oil': 1500},  cost_grows: 1.46, profit: {'balances.money': 2000}, base_duration: 70, cycle: 300, text: 'text', isHidden: (store) => store.buildings.oil2.level == 0 },
    ...
    materials1space: {name: "Materials1", location: 'space', tier: 1, type: 'helium',    base_cost: {'special.rockets': 1, 'balances.money': 0,          'balances.materials': 5,    'balances.helium': 0},     cost_grows: 1.51, profit: {'balances.helium': 1},       base_duration: 120, cycle: 30,   text: 'text', isHidden: (store) => store.buildings.money1space.level == 0 },
    helium1space:    {name: "Helium1",    location: 'space', tier: 1, type: 'money',     base_cost: {'special.rockets': 1, 'balances.money': 0,          'balances.materials': 0,    'balances.helium': 10},    cost_grows: 1.52, profit: {'balances.money': 1},        base_duration: 130, cycle: 10,   text: 'text', isHidden: (store) => store.buildings.materials1space.level == 0 },
    money2space:     {name: "Money2",     location: 'space', tier: 2, type: 'money',     base_cost: {'special.rockets': 1, 'balances.money': 12500000,   'balances.materials': 0,    'balances.helium': 0},     cost_grows: 1.53, profit: {'balances.money': 40},       base_duration: 140, cycle: 100,  text: 'text', isHidden: (store) => store.buildings.helium1space.level == 0 },
    materials2space: {name: "Materials2", location: 'space', tier: 2, type: 'materials', base_cost: {'special.rockets': 1, 'balances.money': 0,          'balances.materials': 200,  'balances.helium': 0},     cost_grows: 1.54, profit: {'balances.materials': 50},   base_duration: 150, cycle: 200,  text: 'text', isHidden: (store) => store.buildings.money2space.level == 0 },
    helium2space:    {name: "Helium2",    location: 'space', tier: 2, type: 'helium',    base_cost: {'special.rockets': 1, 'balances.money': 0,          'balances.materials': 0,    'balances.helium': 300},   cost_grows: 1.55, profit: {'balances.helium': 70},      base_duration: 160, cycle: 400,  text: 'text', isHidden: (store) => store.buildings.materials2space.level == 0 },
    money3space:     {name: "Money3",     location: 'space', tier: 3, type: 'helium',    base_cost: {'special.rockets': 1, 'balances.money': 1500000000, 'balances.materials': 0,    'balances.helium': 0},     cost_grows: 1.56, profit: {'balances.helium': 200},     base_duration: 170, cycle: 600,  text: 'text', isHidden: (store) => store.buildings.helium2space.level == 0 },
